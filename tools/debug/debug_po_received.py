#!/usr/bin/env python3
"""Manual debug script to inspect received qty data for a PO; not part of the main app."""

import json

from main import MARKETPLACE_IDS, _fetch_po_details_from_api, _fetch_vendor_shipments_for_po
