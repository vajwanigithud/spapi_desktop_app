...
def perf_stats():
    """
    Lightweight performance telemetry endpoint (internal).
    """
    indexes: List[Dict[str, Any]] = []
    indexes.extend(db_repos.list_indexes_for_table("vendor_po_lines"))
    indexes.extend(list_catalog_indexes(CATALOG_DB_PATH))
    return {
        "build": "perf_wave_3B",
        "db_indexes": indexes,
