#!/usr/bin/env python
"""
Migration script to upgrade vendor_po_lines schema from old to new.

Old schema had: acknowledged_qty (wrong)
New schema has: accepted_qty (correct per SP-API)

This script safely migrates the table if it exists.
"""
import sqlite3
